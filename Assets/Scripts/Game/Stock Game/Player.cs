...
{ 
    ...
    void InitNeuralNetwork()
    {
        ...
        {
            Game.player1Net = LoadNetwork(GameManager.instance.mutatePlayer1Number, $"Assets/Scripts/Game/AI/Clay FeedForward/BestNets/{GameManager.instance.layersString}/Player1/");
            GameManager.instance.mutatePlayer1Number++;
        }
        else                            //If this is player 2
        {
            Game.player2Net = LoadNetwork(GameManager.instance.mutatePlayer2Number, $"Assets/Scripts/Game/AI/Clay FeedForward/BestNets/{GameManager.instance.layersString}/Player2/");
