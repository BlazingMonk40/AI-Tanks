            ...
            while ((line = reader.ReadLine()) != null)
            {
                ...
                else
                {
                    ...
                    if (tokens != null && tokens.Length > 2)
                    {
                        ...
                        List<Data> temp = (List<Data>)map[wind];
                        temp.Add(new Data(float.Parse(tokens[0]), float.Parse(tokens[1]), wind, float.Parse(tokens[3]), float.Parse(tokens[4])));
                        map[wind] = temp;
                    }
                }
            }
